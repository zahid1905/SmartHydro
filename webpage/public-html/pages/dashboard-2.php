...
<body>
    ...
    <main>
      <div class="container text-center">
        ...
        <div class="row">
          <div class="card  p-4 border-0  rounded-4 m-1">
            <div class="row justify-content-evenly">
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">sensor 1</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
                  <div class="card-footer bg-success">
                    <button type="button" class="btn btn-outline-light ps-3 pe-3" onclick="no_definidoS()">
                          Abrir
                    </button>
                  </div>      
                </div>
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">Sensor 2</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">Sensor 3</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
        ...
        <div class=" card m-2 border-0">
          <div class="row ">
            <div class="col-3">
              <h class="h4">Actuadores</h>
              <hr class="border border-success opacity-100 border-3  rounded-2">
            </div>
          </div>
        </div>

        <!--Modulo de los actuadores-->
        <div class="row">
          <div class="card  p-4 border-0  rounded-4 m-1">
            <div class="row justify-content-evenly">
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">Bomba 1</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
                  <div class="card-footer bg-success">
                    <button type="button" class="btn btn-outline-light ps-3 pe-3" onclick="abrir()" data-bs-toggle="modal" data-bs-target="#exampleModal">
                          Abrir
                    </button>
                  </div>      
                </div>
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">Bomba 2</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
                  <div class="card-footer bg-success">
                    <button type="button" class="btn btn-outline-light ps-3 pe-3" onclick="no_definidoA()">
                          Abrir
                    </button>
                  </div>      
                </div>
              ...
              <div class="col">
                <div class="card text-center border-success rounded-3 border-2 m-2" style="max-width: 9rem;">
                  <div class="card-header bg-success border-0 p-0">
                    <p class="fs-5 fw-medium text-light">Bomba 3</p>
                  </div>
                  <div class="card-body">
                    <img class="d-inline-block align-text-top" src="../img/snesor.png" alt="Logo" width="50" height="40"/>
                  </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 text-success text-center" id="exampleModalLabel">Sensor o Actuador</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  Estado del sensor o actuador
                  <div id="mostrar_sensor_estado"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="encender()">Encender</button>
                    <button type="button" class="btn btn-success" onclick="apagar()">Apagar</button>
    ...
    <script src="../js/grafica_dias-2.js"></script>
    <script src="../js/estados-actuadores-2.js"></script>
